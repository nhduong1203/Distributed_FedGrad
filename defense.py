...
class FedGrad(Defense):
    ...
    def exec(self, client_models, num_dps, net_freq, net_avg, g_user_indices, pseudo_avg_net, round, selected_attackers, model_name, device, *args, **kwargs):
        ...
        # soft = [g_user_indices[i] for i in suspicious_idxs_1]
        #print("[Soft-filter] predicted suspicious set is:: ", soft)
        ...
        # hard = [g_user_indices[i] for i in suspicious_idxs_2]
        # print("[Hard-filter] predicted suspicious set is: ", hard)
        ...
        # pseudo_final = [g_user_indices[i] for i in final_suspicious_idxs]
        # print(f"[Combination-result] predicted suspicious set is: {pseudo_final}")
        ...
        # filtered = [g_user_indices[i] for i in filtered_suspicious_idxs]
        # print(f"[Filtered-result] predicted suspicious set is: {filtered}")     
        ...
        final = [g_user_indices[i] for i in final_suspicious_idxs]
        print(f"[Final-result] predicted suspicious set is: {final}")   
