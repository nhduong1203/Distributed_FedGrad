...
#$ -l rt_G.small=1
#$ -l h_rt=54:00:00
#$ -o /home/aaa10078nj/Federated_Learning//HaiDuong_DistFedGrad/logs/attackType/$JOB_NAME_$JOB_ID.log
#$ -j y
​
...
python --version
LOG_DIR="/home/aaa10078nj/Federated_Learning/HaiDuong_DistFedGrad/logs/attackType/$JOB_NAME_$JOB_ID"
rm -r ${LOG_DIR}
mkdir ${LOG_DIR}
​
