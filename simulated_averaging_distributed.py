...
from utils import *
from fl_trainer_distributed import *
...
if __name__ == "__main__":
    ...
    parser.add_argument('--number_verifiers', type=int, default=10,
                        help='number verifiers per round') 
    parser.add_argument('--clients_per_verifier', type=int, default=10,
                        help='number clients per verifier') 
    parser.add_argument('--randomChoose', type=bool_string, default=True,
                        help='')  
    ...
    arguments = {
        ...
        "log_folder": args.log_folder,
        "number_verifiers": args.number_verifiers,
